...
export let AttributeSuite = (SCIMMY) => {
    ...
    function instantiateFromFixture(fixture) {
        let {type, name, mutability: m, uniqueness: u, subAttributes = [], ...config} = fixture;
        return new SCIMMY.Types.Attribute(type, name, {mutable: m, uniqueness: !u ? false : u, ...config}, subAttributes.map(instantiateFromFixture));
    }
    ...
    describe("SCIMMY.Types.Attribute", () => {
        ...
        it("should not accept 'subAttributes' argument if type is not 'complex'", () => {
            assert.throws(() => 
                (new SCIMMY.Types.Attribute("string", "test", {}, [new SCIMMY.Types.Attribute("string", "other")])),
        ...
        describe("#toJSON()", () => {
            it("should have instance method 'toJSON'", () => {
                let attribute = new SCIMMY.Types.Attribute("string", "test");
                assert.ok(typeof attribute.toJSON === "function", "Instance method 'toJSON' not defined");
            });
            ...
            it("should produce valid SCIM attribute definition objects", async () => {
                ...
                for (let fixture of suite) {
                    let attribute = instantiateFromFixture(fixture);
        ...
        describe("#truncate()", () => {
            it("should have instance method 'truncate'", () => {
                let attribute = new SCIMMY.Types.Attribute("string", "test");
                assert.ok(typeof attribute.truncate === "function", "Instance method 'truncate' not defined");
            });
            ...
            it("should do nothing without arguments", async () => {
                ...
                for (let fixture of suite) {
                    ...
                    assert.deepStrictEqual(
                        JSON.parse(JSON.stringify(attribute.truncate())), fixture,
            ...
            it("should remove specified sub-attribute from 'subAttributes' collection", async () => {
                ...
                for (let fixture of suite) {
                    ...
                    assert.deepStrictEqual(
                        JSON.parse(JSON.stringify(attribute.truncate(target))), comparison,
        ...
        describe("#coerce()", () => {
            it("should have instance method 'coerce'", () => {
                let attribute = new SCIMMY.Types.Attribute("string", "test");
                assert.ok(typeof attribute.coerce === "function", "Instance method 'coerce' not defined");
            });
